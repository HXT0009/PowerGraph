...
However, there may exist some bugs on PowerGraph using the above command(boost_1_53_0.tar, eigen_3.12.tar, gperftools-2.0.tar, libevent-2.0.18-stable.tar may not be available)

You can download the PowerGraph from this Github Repository(Amend). This type of PowerGraph fixed the above problems.
