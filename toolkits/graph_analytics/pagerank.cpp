 ...
 */
void init_vertex(graph_type::vertex_type& vertex) { vertex.data() = 2.5; }
...
public:
  ...
  double gather(icontext_type& context, const vertex_type& vertex,
    ...
    std::cout<<"Hello!!!!!!!!!!GATHER!!!!!!!!!!!!!!!!!!!!!!"<<edge.source().num_out_edges()<<std::endl;
...
int main(int argc, char** argv) {
  ...
  engine.signal_all();
  std::cout<<"Hello!!!!!!!!!!!!(11111111)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
  engine.start();
  std::cout<<"Hello!!!!!!!!!!!!(22222222)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
